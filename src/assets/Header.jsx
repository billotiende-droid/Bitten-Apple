...
function Header() {
  return (
    <header className="bg-gray-200 p-6 border-b border-gray-300 rounded-2xl">
      <div className="flex items-center max-w-7xl mx-auto w-full ml-7">
        ...
        {/* Navigation Links */}
        <nav className=" md:flex flex-1 justify-center space-x-10 font-semibold mask-b-from-neutral-100 font-sans">
          <a href="#home" className="hover:text-blue-300">Store</a>
          <a href="#about" className="hover:text-blue-300">Featured</a>
          <a href="#resources" className="hover:text-amber-500">Accessories</a>
          <a href="#resources" className="hover:text-gray-700">Experience</a>
          <a href="#resources" className="hover:text-blue-300">Support</a>
        </nav>

        {/* Search, User, Cart */}
        <div className="flex items-center gap-6 ">
          <Search className="cursor-pointer hover:text-amber-300" />
