  ...
  const accessories = [
    {
      ...
      price: 249,
      image:
        "https://applecenter.co.ke/wp-content/uploads/2021/01/Magsafe-Charger-0-1024x1024.jpeg"
    },
    {
      name: "Silicon Case",
      price: 39,
      image:
        "https://i.pinimg.com/1200x/c1/de/56/c1de561d5a923ee6237e4d84ca981abc.jpg"
    },
    {
      name: "AirPods Pro",
      price: 225,
      image:
        "https://i.pinimg.com/736x/36/bb/cd/36bbcdf88bbd6832638717628e4200e4.jpg"
    }
  ];
    ...
    <section id="accessories" className="py-20 bg-white/40 backdrop-blur-sm">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-slate-900 mb-4">Essential Accesories</h2>
          <p className="text-slate-600 max-w-2xl mx-auto">
            Complete your iPhone experience with our curated selection of
            premium accessories.
          </p>
        </div>
