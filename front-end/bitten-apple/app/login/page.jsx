...
export default function LoginPage() {
    ...
    return (
        <div className="[288px] flex bg-slate-50 text-slate-900">
            ...
            <form onSubmit={handleSubmit} className='space-y-5'>
                ...
                <div className='flex justify-center gap-4 mb-6'>
                    <button
                       ...
                       <button className='p-3 border border-slate-200 rounded-full hover:bg-slate-50 text-[#1877F2] transition-colors shadow-sm'>
                        <FaFacebook size={22} />
                       </button>
